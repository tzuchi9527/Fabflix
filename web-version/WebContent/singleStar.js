...
function handleResult(resultData) {
    ...
    for (let i = 0; i < resultData.length; i++) {
        ...
        rowHTML += "<tr>";
        rowHTML += "<th>" ;
        rowHTML +=  '<a href="singleMovie.html?movieId=' + resultData[i]["movie_id"] +'">';
...
jQuery.ajax({
    ...
    url: "singleStar?starId=" + starId, // Setting request url, which is mapped by StarsServlet in Stars.java
